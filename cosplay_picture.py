...
urls = ['http://www.cosplay0.com/cosplayfuli/20180306/590_{}.html'.format(str(i)) for i in range(2,14)]
...
for url in urls:
    ...
    links = soup.find_all('img',alt=r'萌妹子裸足福利守望先锋D.vaCos死库水美女写真图片', src=re.compile(r'.jpg$'))
